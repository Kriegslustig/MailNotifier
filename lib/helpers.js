...
module.exports = {
  ...
  getFilePath: function (type, fileName, global) {
    return (this.isGlobal() || global) && this.filePaths[type] ? this.filePaths[type] + fileName : './' + fileName
  },
  ...
  appendToFile: function (fileName, text) {
    fs.writeFileSync(this.getFilePath('config', fileName), text)
  },

  overwriteFile: function (fileName, text) {
    fs.writeFileSync(this.getFilePath('config', fileName), text, {flag: 'w'})
  },
